...
mod start {
    ...
    fn link() {
        assert_eq!(
            s(Start(Link(LinkType::Inline, "uri".into(), "title".into()))),
            "["
        )
    }
    #[test]
    fn link_without_title() {
        assert_eq!(
            s(Start(Link(LinkType::Inline, "uri".into(), "".into()))),
            "["
        )
    }
    #[test]
    fn image() {
        assert_eq!(
            s(Start(Image(LinkType::Inline, "uri".into(), "title".into()))),
            "!["
        )
    }
    #[test]
    fn image_without_title() {
        assert_eq!(
            s(Start(Image(LinkType::Inline, "uri".into(), "".into()))),
            "!["
        )
    }
    #[test]
...
mod end {
    ...
    fn link() {
        assert_eq!(
            s(End(Link(LinkType::Inline, "/uri".into(), "title".into()))),
            "](/uri \"title\")"
        )
    }
    #[test]
    fn link_without_title() {
        assert_eq!(
            s(End(Link(LinkType::Inline, "/uri".into(), "".into()))),
            "](/uri)"
        )
    }
    #[test]
    fn image() {
        assert_eq!(
            s(End(Image(LinkType::Inline, "/uri".into(), "title".into()))),
            "](/uri \"title\")"
        )
    }
    #[test]
    fn image_without_title() {
        assert_eq!(
            s(End(Image(LinkType::Inline, "/uri".into(), "".into()))),
            "](/uri)"
        )
    }
    #[test]
